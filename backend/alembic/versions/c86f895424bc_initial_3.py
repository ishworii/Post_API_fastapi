...
Revision ID: c86f895424bc
Revises: 6bbc5609746a
Create Date: 2024-10-08 06:14:45.642827
...
revision: str = "c86f895424bc"
down_revision: Union[str, None] = "6bbc5609746a"
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["post_id"], ["post.id"], name="comments_post_id_fkey", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["post_id"],
            ["post.id"],
            name="subscriptions_post_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
        ...
        sa.UniqueConstraint("user_id", "post_id", name="user_post_subscriber_unique"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["post_id"], ["post.id"], name="likes_post_id_fkey", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["author_id"], ["users.id"], name="post_author_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            postgresql.ENUM("normal", "admin", name="userrole"),
            autoincrement=False,
            nullable=True,
        ),
