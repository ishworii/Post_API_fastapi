...
Revision ID: 5e6cd4636ee8
Revises: c86f895424bc
Create Date: 2024-10-18 10:01:01.042147
...
revision: str = "5e6cd4636ee8"
down_revision: Union[str, None] = "c86f895424bc"
...
def downgrade() -> None:
    ...
    # sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
    # sa.Column('post_id', sa.INTEGER(), autoincrement=False, nullable=False),
    # sa.ForeignKeyConstraint(['post_id'], ['post.id'], name='subscriptions_post_id_fkey', ondelete='CASCADE'),
